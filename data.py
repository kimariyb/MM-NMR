...
class DataModule(LightningDataModule):
    ...
    def prepare_dataset(self):
        if self.hparams["dataset"] == "carbon":
            self.dataset = CarbonSpectraDataset(self.hparams["dataset_root"],)
        elif self.hparams["dataset"] == "hydrogen":
            self.dataset = HydrogenSpectraDataset(self.hparams["dataset_root"],)
        elif self.hparams["dataset"] == "fluorine":
            self.dataset = FluorineShiftDataset(self.hparams["dataset_root"],)
        else:
            raise ValueError(f"Invalid dataset: {self.hparams['dataset']}")
